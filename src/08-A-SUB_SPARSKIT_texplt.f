...
c          job1 = 0 : a filled square
c          job1 = 1 : a filled circle
c          job1 = 2 : the message $a_{ij}$ where i,j are the row/column
...
c     add diagonal element if MSR mode.
 ...
 1    continue
c-----------------------------------------------------------------------
 12   format ('\put(',F9.2,',',F9.2,')','{\boxd}')
 13   format ('\put(',F9.2,',',F9.2,')','{$a_{',i3,1h,,i3,'}$}')
c-----------------------------------------------------------------------

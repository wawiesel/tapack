      MODULE LIB_LAPACK_BLAS
      !!#PURPOSE
      !! The LAPACK BLAS in a module.
...
c
      double complex zx(*)
      double precision stemp !!#WAW#,dcabs1
      integer i,incx,ix,n
c
      dzasum = 0.0d0
      stemp = 0.0d0
...
*     .. Local Scalars ..
     ...
     $                   LENX, LENY
*     .. External Functions ..
 !!#WAW# !!#WAW#      LOGICAL            LSAME
 !!#WAW# !!#WAW#      EXTERNAL           LSAME
*     .. External Subroutines ..
 !!#WAW# !!#WAW#      EXTERNAL           XERBLA
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
*     .. Executable Statements ..
...
*
     ...
     $            C3.EQ.'QLF' ) THEN
      ...
      ELSE IF( SNAME .AND. C2.EQ.'OR' ) THEN
         IF( C3( 1:1 ).EQ.'G' ) THEN
            IF( Csp.EQ.'QR' .OR. Csp.EQ.'RQ' .OR. Csp.EQ.'LQ' .OR.
     $          Csp.EQ.'QL' .OR. Csp.EQ.'HR' .OR. Csp.EQ.'TR' .OR.
     $          Csp.EQ.'BR' ) THEN
               NB = 32
            END IF

C# LIBRARY MODULE <<SPARSKIT_blassm>>
        MODULE LIB_SPARSKIT_blassm

C## PURPOSE
C Defines basic linear algebra for sparse matrices as part of the
C SPARSKIT, version 2, package.


C## DEPENDENCIES
        USE LIB_SPARSKIT_formats !!((04-A-LIB_SPARSKIT_formats.f))
        USE LIB_SPARSKIT_unary   !!((03-A-LIB_SPARSKIT_unary.f))
        USE LIB_SPARSKIT_inout   !!((03-A-LIB_SPARSKIT_inout.f))

C## MODIFICATIONS
C {May2006}
C   [waw] | William A. Wieselquist | william.wieselquist AT gmail.com
C   * conversion to module
C   * moved <roscal> from <LIB_SPARSKIT_unary> into this module,
C     <LIB_SPARSKIT_blassm>, to remove circular references
C   * moved <coscal> from <LIB_SPARSKIT_unary> into this module,
C     <LIB_SPARSKIT_blassm>, to remove circular references

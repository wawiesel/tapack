      MODULE LIB_SPARSKIT_iters
        USE LIB_SPARSKIT_blas1             !!((03-A-LIB_SPARSKIT_blas1.f))
      use LIB_SPARSKIT_itaux,ONLY: distdot !!((07-A-LIB_SPARSKIT_itaux.f))
        CONTAINS
c----------------------------------------------------------------------c
c                          S P A R S K I T                             c
c----------------------------------------------------------------------c
...
c     types of convergence tests: (1) tests based on the residual norm;
...
c
![waw]-all internal now
![waw]      real*8 distdot
![waw]      logical stopbis, brkdn
![waw]      external distdot, stopbis, brkdn, bisinit
c
c     local variables
c
      integer i
...
c     external functions used
c
c[waw]-all internal now
c[waw]      real*8 distdot
c[waw]      logical stopbis, brkdn
c[waw]      external distdot, stopbis, brkdn, bisinit
c
c     local variables
c
      integer i
...
c[waw]      real*8 distdot
c[waw]      logical stopbis,brkdn
c[waw]      external distdot, stopbis, brkdn
c
      real*8 one
      parameter(one=1.0D0)
c
...
c
      ...
      real*8 alpha,beta,psi,c,s
c[waw]  real*8 distdot
      logical lp,rp,full
c[waw]      external distdot,bisinit
      save
c
c     where to go
c

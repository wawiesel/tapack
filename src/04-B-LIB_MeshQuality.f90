...
!
!    Output, logical DMAT_IN_01, is TRUE if every entry of A is
!    between 0 and 1.
!
  implicit none
...
!*******************************************************************************
!
!! DMAT_UNIFORM_01 fills an array with pseudorandom numbers.
!
!  Modified:
!
!    11 August 2004
...
!
!    Output, integer TRIANGLE_NODE(3,TRIANGLE_NUM), the nodes that make up each
...
subroutine dvec_normal_01 ( n, seed, x )
...
!*******************************************************************************
!
!! DVEC_UNIFORM_01 fills a vector with pseudorandom numbers.
!
!  Modified:
!
!    19 August 2004
...
!
  ...
  call dmat_uniform_01 ( dim_num, n, seed, x )
...
!
    call dvec_normal_01 ( m, seed, x(1:m,j) )
!
...
!
  ...
  if ( .not. dmat_in_01 ( dim_num, n, z ) ) then
!   write ( *, '(a)' ) ' '
...
!   write ( *, '(a)' ) '  Some data is not in the unit hypercube.'
  ...
  if ( verbose ) then
    ...
    write ( *, '(a,i6)'   ) '  Number of points is ', n
    if ( walls ) then
      write ( *, '(a)' ) &
...
!    Input, integer TRIANGLE_NUM, the number of triangles.
!
!    Input/output, integer TRIANGLE_NODE(3,TRIANGLE_NUM), the triangle incidence
...
!
  ...
  write ( string, '(a,1x,i2,1x,i4,2x,i2,a1,i3.2,a1,i2.2,a1,i6.3,1x,a)' ) &

...
c
   ...
   30 continue
      ...
      subroutine  dcopy666(n,dx,incx,dy,incy)
c
c     copies a vector, x, to a vector, y, with dy being integer.
c     uses unrolled loops for increments equal to one.
c     jack dongarra, linpack, 3/11/78 | william wieselquist, 5/8/2006
c
